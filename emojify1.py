...
index = 1
print(X_train[index], label_to_emoji(Y_train[index])) #expected i am proud of your achievements (happy)
...
#get 50_D data from Glove file
word_to_index, index_to_word, word_to_vec_map = read_glove_vecs('data/glove.6B.50d.txt')
'''
	word_to_index:from word to index 400000 words
	index_to_word:no need to explain
	word_to_vec_map:from word to Glove vec
...
#test sentence 
X_my_sentences = np.array(["", "i love you", "funny lol", "lets play with a ball", "food is ready", "you are not happy"])
